...
import { useQuery } from '../../Shared/router'
...
export const TournamentPage = () => {
  ...
  useEffect(() => {
    ...
    const tournamentId = query.get('tournamenId')

    if (!teamId || !tournamentId) return
    const tournament = tournamentId.split('-')
    ...
    fetchTournamentResults(teamId, tournament)
    .then((value: any) => {
      setTournamentResults(value)
    })

    fetchTournamentNextMatches(teamId, tournament)
    .then((value: any) => {
